  ...
  return (
    <section className="mx-auto w-11/12 my-10">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-maroon dark:text-pale-white">Movie Reviews</h1>
          <p className="text-base-content/70 mt-2">What people are saying about recent films</p>
        </div>
          ...
          {reviewsData.map((review) => (
            <div key={review.id} className="p-3 border border-gray-200 rounded-sm">
              <div className="card-body">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <h4 className="font-medium ">From <span className="italic text-prussian-blue dark:text-pale-white">{review.userName}</span></h4>
                ...
                <div className="mt-4">
                  <div className="badge bg-prussian-blue text-white dark:bg-prussian-blue/40 font-medium mr-2">
                    {review.movieName}
                  </div>
                  <div className="badge badge-ghost">
                    {review.movieGenre.split(',').join(' | ')}
                  </div>
                </div>
